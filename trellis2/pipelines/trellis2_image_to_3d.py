...
class Trellis2ImageTo3DPipeline(Pipeline):
    ...
    def remove_bg(self, input: Image.Image) -> Image.Image:
        """
        Remove background from the input image.

        Args:
            input (Image.Image): The input image.
        """
        import time
        ...
        print(f">>>>>>>>>>>>>>>>>>>>>>>   Background removal took {duration:.2f} seconds.")
        return output_image
